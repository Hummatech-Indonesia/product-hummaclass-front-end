        ...
        $(document).ready(function() {
            ...
            function getDivision() {
                $.ajax({
                    ...
                    dataType: "json",
                    success: function(response) {
                        $('.classroom-division-id-input').empty();
                        $.each(response.data, function(indexInArray, valueOfElement) {
                            $('.classroom-division-id-input').append(listDivision(
                ...
                <li>
                    <div class="form-check form-check-inline sidebar-link filter-option">
                        <input class="form-check-input filter-radio" 
                            ...
                            data-class-level="${value.class_level}" 
            ...
            $(document).on('change', '.filter-radio', function() {
                ...
                const selectedClassroomClassLevel = $(this).data('class-level');
                ...
                $('#edit-classroom-button')
                    ...
                    .data('name', selectedClassroomName)
                    .data('class_level', selectedClassroomClassLevel);
            ...
            $(document).on('click', '#edit-classroom-button', function() {
                ...
                $('#edit-classroom-name-input').val(name);
                $('#edit-classroom-division-input').val(division_id);
                $('#edit-classroom-class-level-input').val(class_level);

                $('#edit-classroom-modal').modal('show')
                $('#edit-classroom-form').off('submit')
                $('#edit-classroom-form').submit(function(e) {
                    e.preventDefault();
                    $.ajax({
                        type: "POST",
