<!-- Modal -->
<div class="modal fade" id="edot-zoom-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog mg-md">
        <div class="modal-content">
            <form action="" id="edot-zoom-form">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit jadwal zoom</h5>
