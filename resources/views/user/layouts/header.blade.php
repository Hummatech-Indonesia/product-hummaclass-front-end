                            ...
                            <div class="select-grp">
                                ...
                                <div class="dropdown-container">
                                    ...
                                    <div id="category-options" class="category-options">
                                        ...
                                        <div class="category-item" data-category="data-science">Data Science</div>
...
<style>
    ...
    .category-options {
        ...
        max-height: 200px;
        overflow-y: auto;
        top: 100%; /* Menampilkan di bawah dropdown kategori */
    }
...
<script>
    ...
    document.addEventListener('click', function(event) {
        if (!categoryOptions.contains(event.target) && !subcategoryDropdown.contains(event.target) && !categoryDropdown.contains(event.target)) {
            categoryOptions.style.display = 'none';
            subcategoryDropdown.style.display = 'none';
        }
    });
