            ...
            <div class="row mt-3">
                <div class="col-lg-4">
                    <div class="card position-relative border-0"
                        style="background-image: linear-gradient(to right, #9C40F7, #7209DB);height:550px;border-radius:20px;">
                        <div class="p-4">
                        ...
                        <div class="position-absolute bottom-0">
                            <img src="{{ asset('assets/img/print-certificate.png') }}" alt=""
                                style="width: 100%; height: auto;">
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <form action="" id="verification-name-certificate">
                        <div class="card p-4 border-0 px-4 pb-5" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15);">
                            <h3>Verifikasi Nama Anda</h3>
                            <p class="mt-3">Anda belum pernah melakukan verifikasi nama untuk cetak sertifikat. Proses ini
                                hanya dapat dilakukan satu kali dan akan digunakan pada seluruh sertifikat kompetensi kelas
                            </p>
