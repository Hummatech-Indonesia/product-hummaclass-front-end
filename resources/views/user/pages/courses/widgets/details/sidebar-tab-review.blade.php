...
<div class="col-xl-3 col-lg-4" id="sidebar-tab-review" style="display: none">
    ...
    <div>
        ...
        <a href="{{ route('courses.print-certificate.index', $id) }}" style="border-radius: 50px; padding: 10px 10px; font-size: 14px;" class="outline-purple-primary w-100 mt-3">
        ...
        <button class="btn btn-primary w-100 mt-3 addReviews" data-bs-toggle="modal" data-bs-target="#modal-create-review">
            Review Kursus
        </button>
