            ...
            <div class="dashboard__nav-wrap">
                <ul class="nav nav-tabs" id="courseTab" style="border-bottom: none !important;" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="btn active-tab active" id="upload-tab" data-bs-toggle="tab"
                            data-bs-target="#upload-tab-pane" type="button" role="tab" aria-controls="upload-tab-pane"
                            aria-selected="true">
                            Upload Berkas
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="btn active-tab" id="link-tab" data-bs-toggle="tab" data-bs-target="#link-tab-pane"
                            type="button" role="tab" aria-controls="link-tab-pane" aria-selected="false">
                            URL Link
                        </button>
                    </li>
                </ul>
...
@section('script')
    ...
    <script>
        ...
        $('#submit-task-btn').on('click', function(event) {
