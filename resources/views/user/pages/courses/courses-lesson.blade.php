    ...
    <div class="container-fluid p-0">
        <div class="row gx-0">
            <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                ...
                                <ul class="list-wrap">
                                    <li class="course-item open-item" onclick="changeContent('Course Installation', 'assets/video/installation.mp4', 'Course Description Installation')">
                                        <a href="#" class="course-item-link active">
                                            <span class="item-name">Course Installation</span>
                                            <div class="course-item-meta">
                                                <span class="item-meta duration">03:03</span>
                                    ...
                                    <li class="course-item open-item" onclick="changeContent('React for Beginners', 'assets/video/react.mp4')">
                                        <a href="#" class="course-item-link">
                                            <span class="item-name">React for Beginners</span>
                                            <div class="course-item-meta">
                                                <span class="item-meta duration">05:10</span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                ...
                <h2 class="title mt-5">Daftar Tugas</h2>
                <ul class="list-wrap">
                    <li class="course-item open-item" onclick="changeContent('Membuat CRUD', 'assets/video/crud.mp4', 'Deskripsi tugas Membuat CRUD')">
                        <a href="#" class="course-item-link active">
                            <span class="item-name">Membuat CRUD</span>
                            <div class="course-item-meta">
                                <span class="item-meta duration">+20 Points</span>
                            </div>
                        </a>
                    </li>
                    <li class="course-item open-item" onclick="changeContent('Membuat CRUD 2', 'assets/video/crud2.mp4', 'Deskripsi tugas Membuat CRUD 2')">
                        <a href="#" class="course-item-link">
                            <span class="item-name">Membuat CRUD 2</span>
                            <div class="course-item-meta">
                                <span class="item-meta duration">+20 Points</span>
                            </div>
                        </a>
