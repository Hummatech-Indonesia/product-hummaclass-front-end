        ...
        <div class="col-12">
            <div class="dashboard__nav-wrap">
                <ul class="nav nav-tabs" id="courseTab" style="border-bottom: none !important;" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="btn active-tab" id="design-tab" data-bs-toggle="tab"
            ...
            <div class="tab-content" id="courseTabContent">
                <div class="tab-pane fade show active" id="all-tab-pane" role="tabpanel" aria-labelledby="all-tab"
                    ...
                    <div class="swiper dashboard-courses-active">
                        <div class="row" id="proses_courses">
    ...
    <script>
        $(document).ready(function() {
            ...
            function get(page) {
                $.ajax({
                    type: "GET",
                    url: "{{ config('app.api_url') }}" + "/api/list-course?page=" + page,
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data.data, function(index, value) {
                            $('#proses_courses').append(card(index, value));
                        });
            ...
            <div class="col-lg-4 col-md-6">
                                    <div class="courses__item courses__item-two shine__animate-item">
                                        ...
                                        <div class="courses__item-content courses__item-content-two">
                                            <ul class="courses__item-meta list-wrap">
                                                <li class="courses__item-tag">
                                                    <a href="course.html">${value.sub_category}</a>
                                                </li>
                                            </ul>
                                            <h5 class="title"><a
                                                    href="{{ route('courses.courses.show', $item) }}">${value.title}</a></h5>
                                            <div class="courses__item-content-bottom">
                                                <div class="author-two">
                                                    <a href="instructor-details.html"><img
                                        ...
                                        <div class="courses__item-bottom-two">
                                            <ul class="list-wrap">
                                                <li><i class="flaticon-book"></i>${value.modules_count}</li>
