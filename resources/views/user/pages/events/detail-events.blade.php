                        ...
                        <div class="col-70">
                            <div class="event__details-content">
                                <div class="event__details-content-top">
                                    <a href="javascript:void(0)" id="detail-is-online" class="tag detail-is-online">Seminar</a>
                                </div>
                                <div class="event__meta">
                                    <ul class="list-wrap">
                                        ...
                                        <li class="location"><i class="flaticon-placeholder"></i><span class="detail-is-online"></span></li>
                                        <li><i class="flaticon-mortarboard"></i><span class="detail-capacity"></span> Siswa</li>
                                    </ul>
                                </div>
                                ...
                                <div class="event__widget">
                                    <div class="courses__details-sidebar">
                                        ...
                                        <div class="courses__payment mt-5">
                                            ...
                                            <p>LIVE at <a href="" class="detail-location" style="color: #9425FE">YouTube HummaTech class</a></p>
                                        ...
                                        <div class="courses__details-enroll">
                                            <div class="tg-button-wrap">
                                                <a href="#" class="btn arrow-btn w-100 d-flex justify-content-center">Masuk <img src="{{ asset('assets/img/icons/right_arrow.svg') }}" alt="img" class="injectable"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
