            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section__title text-center mb-40">
                        ...
                        <p class="desc">belajar dari instruktur terbaik di kelas langsung terlibat, berinteraksi dan menyelesaikan keraguan</p>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="card shadow-none border-0" style="background-color: #F6EEFE;border-radius:20px;">
                            <div class="card-body p-4 px-5">
                              <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center justify-content-center p-3" style="border-radius: 50%; background-color:#9425FE">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"><path fill="white" d="M12 3L1 9l4 2.18v6L12 21l7-3.82v-6l2-1.09V17h2V9zm6.82 6L12 12.72L5.18 9L12 5.28zM17 16l-5 2.72L7 16v-3.73L12 15l5-2.73z"/></svg>
                                </div>
                                <h5 class="mb-0 ms-3">Mentor Terpercaya</h5>
                              </div>
                              <div class="d-flex align-items-center mt-3">
                                <p style="font-size: 15px;">Mentor Kami ramah dan ahli dalam domain untuk membuat Anda belajar dengan mudah</p>
                              </div>
                            </div>
                          </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="card shadow-none border-0" style="background-color: #EEF0FE;border-radius:20px;">
                            <div class="card-body p-4 px-5">
                              <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center justify-content-center p-3" style="border-radius: 50%; background-color:#2925FE">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><g fill="none" stroke="white"><path d="M20 12v5c0 1.886 0 2.828-.586 3.414S17.886 21 16 21H6.5a2.5 2.5 0 0 1 0-5H16c1.886 0 2.828 0 3.414-.586S20 13.886 20 12V7c0-1.886 0-2.828-.586-3.414S17.886 3 16 3H8c-1.886 0-2.828 0-3.414.586S4 5.114 4 7v11.5"/><path stroke-linecap="round" d="M9 8h6"/></g></svg>
                                </div>
                                <h5 class="mb-0 ms-3">Kursus Terbaik</h5>
                              </div>
                              <div class="d-flex align-items-center mt-3">
                                <p style="font-size: 15px;">Semua kursus kami dibuat dan untuk membuat Anda menikmati mempelajari hal-hal baru</p>
                              </div>
                            </div>
                          </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="card shadow-none border-0" style="background-color: #FEF5EE;border-radius:20px;">
                            <div class="card-body p-4 px-5">
                              <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center justify-content-center p-3" style="border-radius: 50%; background-color:#FFB649">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="white" d="M6 3h8.99v1.5H6zM2.99 6h1.5v1.5h-1.5zm0-3h1.5v1.5h-1.5zm0 6.01H4.5v1.5H2.99z"/><path fill="white" d="M4.5 12h-3V1.49h15V6H18V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v9.48a2 2 0 0 0 2 2h2.5Z"/><path fill="white" d="M22 7.5H8a2 2 0 0 0-2 2V19a2 2 0 0 0 2 2h5.53v1.53H12V24h6v-1.49h-1.5V21H22a2 2 0 0 0 2-2V9.5a2 2 0 0 0-2-2m.51 12h-15V9h15Z"/></svg>
                                </div>
                                <h5 class="mb-0 ms-3">Tugas Kompetensi</h5>
                              </div>
                              <div class="d-flex align-items-center mt-3">
                                <p style="font-size: 15px;">Bergabunglah dengan kelas kami dengan alat interaktif dan dukungan keraguan</p>
                              </div>
                            </div>
                          </div>
                    </div>
