...
@section('content')
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-9">
                    <div class="about__images">
                        ...
                        <img src="{{ asset('assets/img/others/about_shape.svg') }}" alt="img"
    ...
    <section class="courses-area section-pt-120 section-pb-90"
        data-background="{{ asset('assets/img/bg/courses_bg.jpg') }}">
        <div class="container">
            ...
            <div class="row gutter-20">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="blog__post-item shine__animate-item">
                        <div class="blog__post-thumb">
                            <a href="blog-details.html" class="shine__animate-link"><img
                                    src="{{ asset('assets/img/blog/blog_post04.jpg') }}" alt="img"></a>
                            <a href="blog.html" class="post-tag bg-warning">Marketing</a>
                        </div>
                        <div class="blog__post-content">
                            <div class="blog__post-meta">
