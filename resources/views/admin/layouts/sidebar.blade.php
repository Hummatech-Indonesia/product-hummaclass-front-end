    ...
    <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="/" class="text-nowrap logo-img">
                <img src="{{ asset('assets/img/logo/get-skill/landscape.png') }}" class="dark-logo" width="180"
                    alt="" />
                <img src="{{ asset('assets/img/logo/get-skill/landscape white.png') }}" class="light-logo" width="180"
                    alt="" />
            </a>
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('admin.configuration.terms-conditions.index') }}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-circle"></i>
                                </div>
