            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-3">
                        ...
                        <button data-id="${value.id}" id="editReward" data-name="${value.name}" data-stock="${value.stock}" data-points_required="${value.points_required}" data-description="${value.description}" data-image="${value.image}"  class="btn px-2 text-white btn-warning editReward">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
