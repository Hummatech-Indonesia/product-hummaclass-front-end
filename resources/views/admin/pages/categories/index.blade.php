                            ...
                            <tr class="fw-semibold">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-3">
                                        <button class="btn text-white deleteCategory" style="background-color: #DB0909;" data-id="${value.id}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                        ...
                                        <button class="btn btn-warning editCategory" data-id="${value.id}" data-name="${value.name}">
