                ...
                <tr class="fw-semibold">
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('admin/dist/images/profile/user-1.jpg') }}" class="rounded-circle me-2 user-profile" style="object-fit: cover" width="40" height="40" alt="">
                            <div class="ms-3">
                                <h6 class="fs-4 fw-semibold mb-0">Alfian Kopling</h6>
                                <span class="fw-normal">Alfian@gmail.com</span>
                            </div>
                        </div>
                    </td>
                    <td>2 Kursus</td>
                    <td>
                        <div class="d-flex gap-3">
                            ...
                            <button class="btn px-2 btn-warning" data-bs-toggle="modal" data-bs-target="#modal-edit">
