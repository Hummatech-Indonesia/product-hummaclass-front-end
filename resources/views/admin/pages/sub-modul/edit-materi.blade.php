    ...
    <div class="row">
        <form action="" id="edit-sub-modul-form">
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn text-white px-4" style="background-color: var(--purple-primary)">Edit</button>
            </div>
        </form>
    </div>
</div>
    ...
    $(document).ready(function() {
        ...
        $('#edit-sub-modul-form').submit(function(e) {
            ...
            editor.save().then((outputData) => {
                ...
                console.log('Title:', formData.get('title')); // Pastikan field name adalah "title"
                console.log('Sub-title:', formData.get('sub_title')); // Pastikan field name adalah "sub_title"
                console.log('Content:', formData.get('content')); // Pastikan field name adalah "content"
                        ...
                        if (errors) {
                            for (let key in errors) {
                                if (errors.hasOwnProperty(key)) {
                                    ...
                                    feedback.text(errors[key][0]); // Mengambil pesan error pertama
