<div id="view-profile" class="card card-body pb-5">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-6 mb-3">
            ...
            <input type="text" class="form-control" id="phone" placeholder="No Telepon" disabled>
        </div>
        <div class="col-lg-6 mb-3">
            <label for="" class="form-label">Jenis Kelamin:</label>
            <input type="text" class="form-control" id="gender" placeholder="Jenis Kelamin" disabled>
        </div>
...
<div id="edit-profile" class="card card-body pb-5" style="display: none;">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-6 mb-3">
            <label for="" class="form-label">Email:</label>
            <input type="text" class="form-control" id="emailtext1" placeholder="Email">
        </div>
        <div class="col-lg-6 mb-3">
            <label for="" class="form-label">No Telepon:</label>
            <input type="text" class="form-control" id="phonetext1" placeholder="No Telepon">
        </div>
        <div class="col-lg-6 mb-3">
            <label for="" class="form-label">Jenis Kelamin:</label>
            <input type="text" class="form-control" id="gendertext1" placeholder="Jenis Kelamin">
        </div>
        <div class="col-lg-12 mb-4">
            <label for="" class="form-label">Alamat:</label>
            <textarea name="" class="form-control" id="addresstext1" cols="30" rows="10"></textarea>
        </div>
    </div>
    <div class="text-end">
