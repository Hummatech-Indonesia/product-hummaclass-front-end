...
<div class="row row-cols-4 mt-4">
    ...
    <div class="col">
        <x-modernize-card-1 author="David Miliar" title="Learning JavaScript WithImagination" subtitle="Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, maiores." content="Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, maiores." img="" price="100000" review="4.5" modules="5" sold="20" />
    </div>
    @empty
    @endforelse
</div>
...
@section('script')
@include('admin.pages.modul.script.index')
@endsection
