...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <textarea name="question" id="question" cols="15" rows="5" class="form-control"></textarea>
            <div class="row">
                <div class="col-6">
                    <label for="option_a" class="form-label" style="font-weight: bold;">Soal</label>
                    <textarea name="option_a" id="option_a" cols="15" rows="5" class="form-control"></textarea>
                </div>
                <div class="col-6">
                    <label for="option_b" class="form-label" style="font-weight: bold;">Soal</label>
                    <textarea name="option_b" id="option_b" cols="15" rows="5" class="form-control"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <label for="option_c" class="form-label" style="font-weight: bold;">Soal</label>
                    <textarea name="option_c" id="option_c" cols="15" rows="5" class="form-control"></textarea>
                </div>
                <div class="col-6">
                    <label for="option_d" class="form-label" style="font-weight: bold;">Soal</label>
                    <textarea name="option_d" id="option_d" cols="15" rows="5" class="form-control"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
    ...
    <div class="card">
        <div class="card-body">
            <h3 style="font-weight: bold;">Pilih Kunci Jawaban</h3>
