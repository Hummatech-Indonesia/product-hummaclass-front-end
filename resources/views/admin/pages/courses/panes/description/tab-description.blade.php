<div class="card position-relative">
    <div class="badge badge-warning position-absolute text-dark p-2 shadow"
        style="font-weight:bold;top: 10px; left: 10px;background-color:#FFC224;" id="sub_category">Development
    </div>
    <div class="d-flex">
        <img src="{{ asset('assets/img/courses/course_thumb01.jpg') }}" alt="" class="rounded">
        <div class="align-items-start p-3">
            <div class="align-items-center">
                <img src="{{ asset('admin/dist/images/profile/user-1.jpg') }}" alt="" class="rounded-circle"
                    width="34" height="34">
                <span>David Millar</span>
            </div>
            <h4 style="font-weight: bold;" class="my-3" id="title">Learning Javascript With Javascript</h4>
            <p id="sub_title">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae fuga eligendi ratione at
            ...
            <h5 style="font-weight: bold;" class="text-primary" id="price">Rp. 300.000 <span
                    class="text-dark fw-normal"> /
                    <span class="text-warning">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                            fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-star">
...
<div class="card">
    <div class="p-3">
        ...
        <p id="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis, assumenda voluptates?
            Distinctio
