<div class="d-flex gap-3 mb-4">
    ...
    {{-- </form> --}}
    {{-- <form action="" class="position-relative"> --}}
    <input type="text" class="form-control product-search px-1 ps-5" style="background-color: #fff" name="name"
                ...
                <div class="card position-relative">
                    <div class="d-flex justify-content-between align-items-center my-3">
                        <div class="p-2" style="left: 0;top:5%;background:linear-gradient(to right,#FFA41C, #FFD08A); border-radius:0 8px 8px 0;width:200px">
                            <span class="text-white" style="font-weight: bold;">Step ke ${value.step}</span>
                        </div>
                        <div class="d-flex gap-2 pe-4 align-items-center">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-8 border-end">
                                <h5 style="font-weight: bold;" class="text-dark">
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="btn btn-light-warning text-warning w-100 d-flex justify-content-start">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <path d="M19 16h-12a2 2 0 0 0 -2 2" />
                                                    <path d="M9 8h6" />
                                                </svg><span class="text-dark ms-2 fs-2" style="font-weight: bold;">${value.sub_module_count}
                                                    Materi</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-2">
