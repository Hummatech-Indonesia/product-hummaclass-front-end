        ...
        <ul class="nav nav-tabs d-flex justify-content-between" role="tablist">
            ...
            <div class="">
                <li class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.create-task.index', $id) }}" class="btn text-white d-none addTask" style="background-color: var(--purple-primary)">
                    ...
                    <a href="{{ route('admin.create-quiz.index', $id) }}" class="btn text-white d-none addQuiz" style="background-color: var(--purple-primary)">
...
<script>
    $(document).on('click', '.btn-delete-task', function() {
        ...
        const url = "https://e-course.mijurnal.com/api/sub-modules/" + id;
