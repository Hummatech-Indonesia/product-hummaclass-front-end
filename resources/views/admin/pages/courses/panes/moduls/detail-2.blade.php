        ...
        <ul class="nav nav-tabs d-flex justify-content-between" role="tablist">
            ...
            <div class="">
                <li class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.create-materi.index', $id) }}" class="btn text-white addMaterials" style="background-color: var(--purple-primary)">
                    ...
                    <a class="btn btn-warning d-none addQuiz" data-bs-toggle="modal" data-bs-target="#settings-quiz">
