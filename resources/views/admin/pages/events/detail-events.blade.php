...
<div class="card" style="border-radius: 15px">
    <div class="card-header p-0">
        <img src="{{ asset('assets/img/courses/course_thumb01.jpg') }}" style="border-radius: 15px 15px 0 0;height:300px;object-fit: cover" class="w-100" alt="">
    </div>
    ...
    <div class="card-body">
        ...
        <div class="mt-3">
            ...
            <h4 class="fs-6 fw-bolder" style="color: var(--purple-primary)">Rp 230.000</h4>
        </div>
        <hr>
