<script>
    ...
    function news(index, value) {
        var fallbackImageUrl = "{{ asset('assets/img/no-image/no-image.jpg') }}";
        ...
        return `
           <div class="col-lg-4">
                <div class="card" style="border-radius: 15px; height: 420px;">
                    ...
                    <img src="${value.thumbnail && value.thumbnail.trim() !== '' ? value.thumbnail : fallbackImageUrl}" class="card-img-top" alt="Thumbnail" style="border-radius: 15px 15px 0 0; height: 200px; object-fit: cover;">
