        ...
        return `
           <div class="col-lg-4">
                <div class="card" style="border-radius: 15px; height: 420px;">
                    ...
                    <img src="${value.thumbnail ? value.thumbnail : '{{ asset('assets/img/no-image/no-image.jpg') }}'}" class="card-img-top" alt="Thumbnail" style="border-radius: 15px 15px 0 0; height: 200px; object-fit: cover;">
