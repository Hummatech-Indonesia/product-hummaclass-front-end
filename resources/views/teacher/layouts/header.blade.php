                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                            ...
                            <div class="message-body" data-simplebar>
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="me-3">
                                        <img src="{{ asset('admin/dist/images/profile/user-2.jpg') }}" alt="user"
                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                            ...
                            <div class="profile-dropdown position-relative" data-simplebar>
                                ...
                                <div class="d-grid py-4 px-7 pt-8">
                                    <div class="mb-2">
                                        <a href="{{ route('mentor.profile.index') }}" style="background-color: var(--purple-primary)" class="btn w-100 text-white">Profile Saya</a>
                                    </div>
                                    <form action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        <button id="logout-btn" class="btn w-100 btn-outline-danger">Log Out</button>
                                    </form>
                                </div>
                            </div>
                        </div>
