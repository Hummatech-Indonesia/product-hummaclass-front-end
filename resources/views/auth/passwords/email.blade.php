                    ...
                    <div class="col-xl-6 col-xxl-6">
                        <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
                            <div class="col-sm-8 col-md-6 col-xl-9">
                                ...
                                <p class=" mb-9">Silakan masukkan alamat email yang terkait dengan akun Anda dan Kami akan mengirimkan email berisi tautan untuk mengatur ulang kata sandi Anda.</p>
                                <form id="send-email-form" class="mt-5">
                                    @csrf
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" style="background-color: #F3F3F3;border:0px;border-radius: 0 12px 12px 0" name="email" id="email" value="{{ old('email', request('email')) }}" placeholder="Email" aria-label="" aria-describedby="basic-addon1">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <button type="submit" class="btn text-white btn-md mt-3 w-100" style="background-color: #9425FE;border-radius: 10px;">
                                        Kirim
                                    </button>
                                    <a href="{{ route('login') }}" class="btn text-dark btn-md mt-3 w-100" style="background-color: #E0E0E0;border-radius: 10px;">
                                        Kembali ke Login
                                    </a>
                                </form>
                            </div>
