                        ...
                        <div
                            ...
                            <div class="col-sm-8 col-md-6 col-xl-9">
                                ...
                                <p class=" mb-9">Silakan masukkan alamat email yang terkait dengan akun Anda dan Kami
                                    akan mengirimkan email berisi tautan untuk mengatur ulang kata sandi Anda.</p>
                                <form id="send-email-form" class="mt-5">
                                    ...
                                    <a href="{{ route('login') }}" class="btn text-dark btn-md mt-3 w-100"
                                        style="background-color: #E0E0E0;border-radius: 10px;">
                                        Kembali ke Login
                                    </a>
                                </form>
                            </div>
