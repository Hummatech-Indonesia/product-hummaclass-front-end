...
<head>
    <!--  Title -->
    <title>Register | Hummaclass</title>
    <!--  Required Meta Tag -->
                    ...
                    <div class="col-xl-6 col-xxl-6">
                        <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
                            <div class="col-sm-8 col-md-6 col-xl-9">
                                ...
                                <h2 class="mb-3 fs-7 fw-bolder">Buat Akun Baru</h2>
                                <p class=" mb-9">Just enter your username and password below and you'll be back in action
                                ...
                                <div class="position-relative text-center my-4">
                                    <p class="mb-0 fs-4 px-3 d-inline-block bg-white text-black z-index-5 position-relative">or</p>
                                ...
                                <form id="register-form">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" style="background-color: #F3F3F3;border:0px;border-radius: 0 12px 12px 0" name="name" id="name" value="{{ old('name', request('name')) }}" placeholder="Nama" aria-label="" aria-describedby="basic-addon1">
                                    ...
                                    <div class="text-center mt-2">
                                        <p style="color: #989898;">Sudah punya akun? <a href="{{ route('login') }}" style="color: #9425FE">Masuk sekarang</a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
