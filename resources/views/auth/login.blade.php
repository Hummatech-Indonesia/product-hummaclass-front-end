    ...
    <script>
        $(document).ready(function() {
            ...
            $('#google-login').click(function(e) {
                e.preventDefault();
                window.location.href = "{{ env('API_URL') }}/api/auth/google"; // Pastikan menempatkan URL dalam tanda kutip
            });
                    ...
                    success: function(response) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                token: response.data.token, // Kirim token dari API ke server Laravel
