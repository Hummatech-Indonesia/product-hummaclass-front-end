                        ...
                        <div class="card-body px-3 pt-0 pb-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col p-0">
                                    ...
                                    <p class="card-text fs-2 text-muted">${value.teacher.user.name}</p>
                                </div>
                            </div>
                            <a href="{{ route('mentor.classroom.show', 1) }}"
